<template>
  <div>
    ...
    <el-table v-loading="loading" :data="items" stripe border>
      ...
      <el-table-column prop="reportedQty" label="报工数量" width="100" />
      <el-table-column prop="actualMinutes" label="实际工时" width="100" />
...
async function reload() {
  ...
  loading.value = true
  try {
    const r = await scanStore.getReportHistory(workorderNo.value.trim())
