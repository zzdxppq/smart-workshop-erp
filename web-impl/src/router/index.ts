...
const routes: RouteRecordRaw[] = [
    ...
    children: [
      ...
      // 1.5 仓储
      {
        ...
        children: [
          ...
          { path: 'inventory-mgr',  name: 'WarehouseInventoryMgr', component: () => import('@/views/warehouse/WarehouseInventoryMgr.vue'), meta: { title: '库存管理', menuGroup: '库存管理' } },
          { path: 'inventory-alert',name: 'InventoryAlert',  component: () => import('@/views/warehouse/InventoryAlert.vue'), meta: { title: '库存预警', menuGroup: '库存预警' } },
          { path: 'stocktake',      name: 'Stocktake',       component: () => import('@/views/warehouse/Stocktake.vue'),       meta: { title: '盘点单', menuGroup: '盘点' } },
          { path: 'locations',      name: 'Locations',       component: () => import('@/views/warehouse/Locations.vue'),     meta: { title: '库位树', hideInMenu: true } },
          ...
          { path: 'batches',        name: 'BatchList',       component: () => import('@/views/warehouse/BatchList.vue'),      meta: { title: '批次列表', hideInMenu: true } },
          { path: 'batch-trace/:batchNo', name: 'BatchTrace', component: () => import('@/views/warehouse/BatchTrace.vue'),     meta: { title: '批次追溯', hideInMenu: true } },
          { path: 'stock-query',    name: 'StockQuery',      component: () => import('@/views/warehouse/StockQuery.vue'),     meta: { title: '库存查询', hideInMenu: true } },
          { path: 'inventory',      name: 'WarehouseInventory', component: () => import('@/views/warehouse/Inventory.vue'),      meta: { title: '库存', hideInMenu: true } },
      ...
      // 2. 销售
      {
        ...
        children: [
          ...
          { path: 'quote-templates', name: 'QuoteCostItems', component: () => import('@/views/sales/QuoteCostItems.vue'), meta: { title: '报价范本', menuGroup: '报价订单' } },
      ...
      // 3. 生产（含 V1.3.7 工序分配）
      {
        ...
        children: [
          ...
          { path: 'allocation',       name: 'Allocation',      component: () => import('@/views/production/Allocation.vue'),     meta: { title: '工序分配', menuGroup: '工单排产', redline: 'no-vendor-dropdown' } },
          { path: 'mrp',              name: 'MRP',             component: () => import('@/views/production/MRP.vue'),            meta: { title: 'MRP 中心', menuGroup: 'MRP中心' } },
          ...
          { path: 'outsource',        name: 'Outsource',       component: () => import('@/views/production/Outsource.vue'),      meta: { title: '委外列表', menuGroup: '委外管理' } },
          ...
          { path: 'outsub-panel',     name: 'OutsubPanel',     component: () => import('@/views/production/OutsourceStateMachine.vue'), meta: { title: '委外面板', menuGroup: '委外管理' } },
      ...
      // 9. 管理（含 V1.3.7 邮件配置）
      {
        ...
        children: [
          ...
          { path: 'audit-logs',      name: 'AuditLogs',      component: () => import('@/views/admin/AuditLogs.vue'),       meta: { title: '审计日志', menuGroup: '系统配置' } },
  ...
  { path: '/quality/outsource-inspection', redirect: '/quality/inspection' },
  ...
  { path: '/warehouse/stock-query', redirect: '/warehouse/inventory-mgr' },
  { path: '/warehouse/batches', redirect: '/warehouse/inventory-mgr' },
  { path: '/warehouse/inventory', redirect: '/warehouse/inventory-mgr' },
